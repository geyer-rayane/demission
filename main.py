...
import os
import subprocess
from lib_analyse import /analyse_apres_nettoyage/analyse_univariee, analyse_table, detect_type, get_var_types
...
table1 = pd.read_csv("table1_clean.csv")
table2 = pd.read_csv("table2_clean.csv")
...
os.makedirs("/analyse_apres_nettoyage/analyse_univariee/table1", exist_ok=True)
os.makedirs("/analyse_apres_nettoyage/analyse_univariee/table2", exist_ok=True)
os.makedirs("/analyse_apres_nettoyage/analyse_bivariee/table1", exist_ok=True)
os.makedirs("/analyse_apres_nettoyage/analyse_bivariee/table2", exist_ok=True)
...
stats_table1 = /analyse_apres_nettoyage/analyse_univariee(table1, quant_table1, qual_table1, "/analyse_apres_nettoyage/analyse_univariee/table1")
print(f"Table1: {len(stats_table1)} variables analysées\n")

stats_table2 = /analyse_apres_nettoyage/analyse_univariee(table2, quant_table2, qual_table2, "/analyse_apres_nettoyage/analyse_univariee/table2")
...
resultats_table1 = analyse_table(table1, "/analyse_apres_nettoyage/analyse_bivariee/table1")
resultats_table1.to_csv("/analyse_apres_nettoyage/analyse_bivariee/resultats_table1.csv", index=False)
print(f"Table1: {len(resultats_table1)} associations\n")

resultats_table2 = analyse_table(table2, "/analyse_apres_nettoyage/analyse_bivariee/table2")
resultats_table2.to_csv("/analyse_apres_nettoyage/analyse_bivariee/resultats_table2.csv", index=False)
